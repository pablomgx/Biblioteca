...
class Bibliotecarios {
     ...
     * @param {*} arrayBibliotecarios, id, nombre, primerApellido, segundoApellido
     */
     ...
     * @param {*} arrayBibliotecarios 
     * @param {*} id 
     */
    borrarBibliotecario(arrayBibliotecarios, id) {
        arrayBibliotecarios[id] = null
